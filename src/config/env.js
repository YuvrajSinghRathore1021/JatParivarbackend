...
export const CONFIG = {
  ...
  FRONTEND_URLS: list(process.env.CORS_ORIGINS || process.env.CORS_ORIGIN, 'http://localhost:5173,http://localhost:4173,https://api.jatparivar.org,https://jatparivar.org,http://jatparivar.org'),
