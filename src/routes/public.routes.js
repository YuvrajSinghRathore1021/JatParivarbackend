...
const serializePublicPerson = (doc) => {
  ...
  return {
    ...
    department: doc.department || user?.department || null,
    education: doc.education || user?.education || null,
    occupation: doc.occupation || user?.occupation || null,
    ...
    order: doc.order,
    socials: doc.socials,
    currentAddress: doc.currentAddress || user?.currentAddress || null,
    parentalAddress: doc.parentalAddress || user?.parentalAddress || null,
    occupationAddress: doc.occupationAddress || user?.occupationAddress || null,
