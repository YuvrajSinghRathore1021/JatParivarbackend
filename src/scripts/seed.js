  ...
  const users = await User.insertMany([
    {
      ...
      occupation: 'Business Owner', designation: 'Kumar Agro',department :'',education:'',
    ...
    },
    {
      ...
      occupation: 'Principal', designation: 'Jat High School',department :'',education:'',
    ...
    },
    {
      ...
      occupation: 'Student', designation: '',department :'',education:'',
      gender: 'male', maritalStatus: 'never_married',
